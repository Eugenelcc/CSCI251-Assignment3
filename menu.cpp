...
vector<Line3D> line3D_vect;
    ...
    int main()
    {
        ...
        while (true)
        {
            ...
            case 5:
                printdata(point2D_vect, point3D_vect, line3D_vect, line2D_vect, filterCriteria, sortCriteria, sortOrder);
                break;
    ...
    void printdata(vector<Point2D> point2D_vect, vector<Point3D> point3D_vect, vector<Line3D> line3D_vect, vector<Line2D> line2D_vect, string filterCriteria, string sortCriteria, string sortOrder)
{
    ...
    else
    {
        if(sortCriteria == "Pt. 1"){
            ...
            if(sortOrder == "ASC"){
                sort(line3D_vect.begin(), line3D_vect.end(), [](Line3D a, Line3D b){return a.getScalarValue() < b.getScalarValue();});
            }
            else if(sortOrder == "DSC"){
                sort(line3D_vect.begin(), line3D_vect.end(), [](Line3D a, Line3D b){return a.getScalarValue() > b.getScalarValue();});
            }
